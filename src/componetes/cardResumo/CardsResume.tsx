    ...
    <ul className='flex gap-6 pb-8 justify-center'>
      ...
      <li className='flex p-5 bg-background-2 border-gray-border-1 border rounded-2xl shadow-card-1 backdrop-blur-[10px] items-center relative w-75.5 overflow-hidden'>
        <div>
          ...
          <h4 className='text-[1.5rem] font-semibold to-blue-text-1'>R$ 70.000,00</h4>
        </div>
      ...
      <li className='flex p-5 bg-background-2 border-gray-border-1 border rounded-2xl shadow-card-1 backdrop-blur-[10px] items-center relative w-75.5 overflow-hidden'>
        <div>
          ...
          <h4 className='text-[1.5rem] font-semibold text-green-5'>6.00%</h4>
        </div>
      ...
      <li className='flex p-5 bg-background-2 border-gray-border-1 border rounded-2xl shadow-card-1 backdrop-blur-[10px] items-center relative w-75.5 overflow-hidden'>
        <div>
          ...
          <h4 className='text-[1.5rem] font-semibold to-blue-text-1'>R$ 500.00</h4>
        </div>
      ...
      <li className='flex p-5 bg-background-2 border-gray-border-1 border rounded-2xl shadow-card-1 backdrop-blur-[10px] items-center relative w-75.5 overflow-hidden'>
        <div>
          ...
          <h4 className='text-[1.5rem] font-semibold to-blue-text-1'>R$ 30.095,50</h4>
        </div>
